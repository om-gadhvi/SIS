...
<body>
	...
	<header>
		...
		<div class="logosec">
			<a href="student_profile.php"><div class="logo" >Student Dashboard</div></a>
		...
		<!-- <a href="Home.php" class="notice"><i class="fa-regular fa-bell fa-shake"></i></a> -->
		<!-- <img src="./image/Notceicon.png" class="icn menuicn" id="menuicn" alt="menu-icon" style="left: 20%;"> -->

		<a href="index.php"><button class="btn"><i class="fa fa-home"></i></i></button></a>
