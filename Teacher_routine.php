...
"image/Fees_icon.png"
					...
					<a href="Teacher_routine.php"><div class="nav-option option5">
						<img src=
			...
			<form>
				<div class="report-container">
					...
					<div class="box-container">
						...
						<div class="box box1">
							<a href="https://drive.google.com/file/d/1KhQbcNyelfp65CpPuffjNLrTH9_maTMf/view?usp=share_link"><div class="text">
								<h2 class="topic-heading1">First Year</h2>
								<h2 class="topic"></h2>
							</div></a>
						</div>
		
						<div class="box box1">
							<a href="https://drive.google.com/file/d/1NU8CM2TyyCCIqne5tnDFH8OTC67aR2y6/view?usp=share_link"><div class="text">
								<h2 class="topic-heading1">Second Year</h2>
								<h2 class="topic"></h2>
							</div></a>
						...
						<div class="box box1">
							<a href="https://drive.google.com/file/d/1NYrdI229nEvuIjWY300QPKGw51agNY-s/view?usp=share_link"><div class="text">
								<h2 class="topic-heading1">Third Year</h2>
								<h2 class="topic"></h2>
							</div></a>
						...
						<div class="box box1">
							<a href="https://drive.google.com/file/d/1NTRvI8IDuRB7_-19VtG7G0vxh4JJDA9l/view?usp=share_link"><div class="text">
								<h2 class="topic-heading1">Fouth Year</h2>
								<h2 class="topic"></h2>
							</div></a>
