        ...
        <form action="insert.php" method="post">
            ...
            <div class="content">
                ...
                <div class="input-box">
                    ...
                    <div id="select" class="input-box">
                        <select name="Sem" id="">
                            <option value="SEM-I" selected="selected">SEM-I</option>
                            <option value="SEM-II" selected="selected">SEM-II</option>
                            <option value="SEM-III" selected="selected">SEM-III</option>
                            <option value="SEM-IV" selected="selected">SEM-IV</option>
                            <option value="SEM-V" selected="selected">SEM-V</option>
                            <option value="SEM-VI" selected="selected">SEM-VI</option>
                            <option value="SEM-VII" selected="selected">SEM-VII</option>
                            <option value="SEM-VIII" selected="selected">SEM-VIII</option>
                            <option selected hidden value="">--select--</option>
                        </select>
                    </div>
                </div>
